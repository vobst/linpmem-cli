...
pub const LINPMEM_CACHE_CONTROL_OPERATION_CCO_SET_TEMPLATE_PTE:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _LINPMEM_CACHE_CONTROL {
    pub op: LINPMEM_CACHE_CONTROL_OPERATION,
    pub __bindgen_anon_1: _LINPMEM_CACHE_CONTROL__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
fn bindgen_test_layout__LINPMEM_CACHE_CONTROL__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<
        _LINPMEM_CACHE_CONTROL__bindgen_ty_1,
    > = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_LINPMEM_CACHE_CONTROL__bindgen_ty_1>(),
        8usize,
        concat!(
            "Size of: ",
    ...
    assert_eq!(
        ::std::mem::align_of::<_LINPMEM_CACHE_CONTROL__bindgen_ty_1>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(_LINPMEM_CACHE_CONTROL__bindgen_ty_1)
    ...
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).template_pte) as usize - ptr as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout__LINPMEM_CACHE_CONTROL() {
    const UNINIT: ::std::mem::MaybeUninit<_LINPMEM_CACHE_CONTROL> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_LINPMEM_CACHE_CONTROL>(),
        16usize,
        concat!("Size of: ", stringify!(_LINPMEM_CACHE_CONTROL))
    );
    assert_eq!(
        ::std::mem::align_of::<_LINPMEM_CACHE_CONTROL>(),
        8usize,
        concat!("Alignment of ", stringify!(_LINPMEM_CACHE_CONTROL))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(_LINPMEM_CACHE_CONTROL),
            "::",
            stringify!(op)
        )
    );
}
pub type LINPMEM_CACHE_CONTROL = _LINPMEM_CACHE_CONTROL;
pub type PLINPMEM_CACHE_CONTROL = *mut _LINPMEM_CACHE_CONTROL;
